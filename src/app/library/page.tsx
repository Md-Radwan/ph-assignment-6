...
const LibraryPage = async () => {
  ...
  return (
    <section id="library" className="container mx-auto px-3 md:px-0">
      <h1 className={`${oswald.className} uppercase font-bold text-3xl leading-9 text-center md:text-left`}>the library</h1>
